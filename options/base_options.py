...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--sort_classes', type=bool, default=False, help='a flag that indicates whether to sort the classes')
        self.parser.add_argument('--sort_order', type=str, default='0-2,3-6,7-9,10-14,15-19,20-29,30-39,40-49,50-69,70-120', help='a specific order to sort the classes, must contain all classes, only works when sort_classes is true')
