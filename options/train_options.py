...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--epochs', type=int, default=200, help='# of epochs to train')
        ...
        self.parser.add_argument('--lambda_id', type=float, default=1.0, help='weight for identity feature loss')
